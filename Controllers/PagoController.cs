...
namespace appPetech.Controllers
{
    ...
    public class PagoController : Controller
    {
        ...
        public IActionResult Pagar(Pago pago)
        {
            ...
            var itemsCart = from o in _context.DataCart select o;
            itemsCart = itemsCart.
            ...
            foreach(var item in itemsCart.ToList()){
            ...
            foreach (Cart p in itemsCart.ToList())
            {
                p.Status="PROCESADO";
            }

            _context.UpdateRange(itemsCart);
